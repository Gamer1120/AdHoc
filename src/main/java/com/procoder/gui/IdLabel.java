...
public class IdLabel extends BorderPane {
    ...
    public IdLabel(String name) {
        ...
        statusView = new ImageView(new Image(this.getClass().getClassLoader()
                .getResourceAsStream("greenBall.png")));
    ...
    public void setActive(boolean active) {
        if (active) {
            statusView.setImage(new Image(this.getClass().getClassLoader()
                    .getResourceAsStream("greenBall.png")));
        } else {
            statusView.setImage(new Image(this.getClass().getClassLoader()
                    .getResourceAsStream("redBall.png")));
        }
    }
